...
| `max_turns` | **Type:** int \| None<br/><br/>**Default:** 3 |
...
| `max_turns` | maximum number of turns (a turn is equivalent to both agents having replied), defaults no None which means unlimited.<br/><br/>The original message is included.<br/><br/>**Type:** int \| None<br/><br/>**Default:** 3 |
