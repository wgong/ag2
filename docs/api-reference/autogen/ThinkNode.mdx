...
|--|--|
| `content` | **Type:** str |
| `parent` | **Type:** ForwardRef('[ThinkNode](/docs/api-reference/autogen/ThinkNode)') \| None<br/><br/>**Default:** None |
...
| `parent` | Parent node to attach to<br/><br/>**Type:** ForwardRef('[ThinkNode](/docs/api-reference/autogen/ThinkNode)') \| None<br/><br/>**Default:** None |

<b>Returns:</b>
| Type | Description |
|--|--|
| [ThinkNode](/docs/api-reference/autogen/ThinkNode) | ThinkNode: Reconstructed node with all children |
