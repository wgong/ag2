...
title: autogen.agents.experimental.document_agent.inmemory_query_engine.InMemoryQueryEngine
---
<h2 id="autogen.agents.experimental.document_agent.inmemory_query_engine.InMemoryQueryEngine" class="doc doc-heading">
