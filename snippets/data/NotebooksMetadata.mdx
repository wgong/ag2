...
export const notebooksMetadata = [
    ...
    {
        "title": "ReasoningAgent - Advanced LLM Reasoning with Multiple Search Strategies",
        "link": "/docs/use-cases/notebooks/notebooks/agentchat_reasoning_agent-u8hi",
        "description": "Use ReasoningAgent for o1 style reasoning in Agentic workflows with LLMs using AG2",
        "image": null,
        "tags": [
            "reasoning agent",
        ...
        "source": "/notebook/agentchat_reasoning_agent-u8hi.ipynb"
    },
    {
    ...
    },
    {
        ...
        "link": "/docs/use-cases/notebooks/notebooks/agents_docagent_u8hi",
        ...
        "source": "/notebook/agents_docagent_u8hi.ipynb"
    },
    {
